  ...
  return (
    <div className="max-w-sm flex justify-center items-center h-screen mx-auto">
      <form className="flex flex-col w-full gap-5 shadow-2xl p-5 rounded">
        ...
        <input value={email} onChange={(e)=>setEmail(e.target.value)} type="email" placeholder="email" className="border border-blue-200 rounded px-2 py-2 outline-none"/>
        <input value={password} onChange={(e)=>setPassword(e.target.value)} type="password" placeholder="password"  className="border rounded px-2 py-2 border-blue-200 outline-none"/>
