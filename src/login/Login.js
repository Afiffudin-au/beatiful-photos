    ...
    <div className='max-w-sm flex p-4 justify-center items-center h-screen mx-auto'>
      <form className='flex flex-col w-full shadow-lg sm:shadow-2xl p-5 rounded'>
        ...
        <input
          ...
          type='email'
          placeholder='email'
          className='mb-5 border border-blue-200 rounded px-2 py-2 outline-none'
        />
        <input
          value={password}
          ...
          className='mb-5 border rounded px-2 py-2 border-blue-200 outline-none'
        />
        <button
          onClick={handleSignIn}
          className='mb-5 text-white font-medium outline-none hover:bg-blue-700 bg-blue-600 rounded px-2 py-2 subpixel-antialiased'>
          Sign In
        </button>
        <button
