...
function Banner() {
  ...
  return <MemoizedChildComponent query={query} setQuery={setQuery} />
}
  ...
  return (
    <div className='banner flex items-center justify-center'>
      <div className='banner-content w-10/12 sm:w-8/12'>
        <h1 className='font-bold text-center text-white text-xl sm:text-3xl mb-8'>
          Amazing free images
        </h1>
        <p className='font-light text-center text-white text-md mb-8'>
          up to 30.000 image is free
        </p>
